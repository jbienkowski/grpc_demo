...
_SEISMOPINGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='seismo.SeismoPingRequest.name', index=0,
...
_SEISMOPINGREPLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='seismo.SeismoPingReply.message', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
SeismoPingRequest = _reflection.GeneratedProtocolMessageType('SeismoPingRequest', (_message.Message,), {
...
SeismoPingReply = _reflection.GeneratedProtocolMessageType('SeismoPingReply', (_message.Message,), {
